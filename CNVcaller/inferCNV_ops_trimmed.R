...
#'                                          no_plot=TRUE)
#'
run_no_smoothing <- function(infercnv_obj,
...
#'
#' @param numNeighbors number of nearest cells to bin by
#'
#' @param dist.method # How to calc dist - options: "euclidean", "maximum", "manhattan", "canberra", "binary" or "minkowski"
#' 
#' @param numIter # Number of iterations for null pathway enrichment distributions
#' 
#' @param pThresh # Padjested threshold for enriched pathways
#'
#' @param numCores # number of cores to analyze with
#'
